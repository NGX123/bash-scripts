-- Panel --
	+ Right click - Configure panel
		...
		+ Widgets
			+ Choose Desktop Switcher - (-) Remove
...
-- Extra --
	+ Remove libre office - sudo apt-get remove --purge libreoffice*
	+ Remove other unneeded apps - sudo apt remove k3b trojita quassel skanlite 2048-qt noblenote
