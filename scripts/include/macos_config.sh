...
if [ $bash_installed == y ]
  then
    ...
    [ ! $(cat $HOME/.bashrc | grep -q '. $HOME/.scripts/color.sh') ] && echo '[ -f $HOME/.scripts/color.sh ] && . $HOME/.scripts/color.sh' >> $HOME/.bashrc
    [ ! $(cat $HOME/.bashrc | grep -q '. $HOME/.scripts/bash_aliases.sh') ] && echo '[ -f $HOME/.scripts/bash_aliases.sh ] && . $HOME/.scripts/bash_aliases.sh' >> $HOME/.bashrc
fi
